...
flowchart TD
    ...
    %% CHANGED: fill:none makes the subgraph backgrounds transparent
    classDef subGraphStyle fill:none,stroke:#cbd5e1,stroke-width:2px,stroke-dasharray: 5 5,rx:10,ry:10
