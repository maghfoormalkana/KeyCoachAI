...
// 1. We move the actual form and logic into a sub-component
function SignInForm() {
    ...
    <>
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-4 bg-[#050814] text-slate-500">or sign in with email</span>
        </div>
      </div>
...
// 2. We export the main page with a Suspense boundary wrapping the form
